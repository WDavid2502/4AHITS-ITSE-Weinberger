...
Dann im kali linux anmelden und anschließend visual studio auf kali linux runter laden. Mit dem Befehl ```sudo apt install code-oss```
...
Diesesn Link öffnen und dann auf "Fine-grained tokens" -> "Generate new Token".
