...
### Cheat Sheet
# Port-Probing & Banner-Grabbing – Cheat Sheet
...
HTTP-Request via Here-Document:
nc <host> 80 <<EOF
GET / HTTP/1.0
...
Nur HTTP-Header anzeigen:
curl -I http://<host>/

Vollständige Header + Infos (verbose):
curl -v http://<host>/

HTTP auf beliebigem Port testen:
