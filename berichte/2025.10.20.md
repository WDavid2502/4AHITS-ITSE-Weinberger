...
-sn – damit fragt Nmap nur ab, welche Rechner im Netz an sind. Es macht keine Port‑Prüfungen. Wenn ein Rechner antwortet, wird er als „online“ gemeldet, sonst nicht. Das ist gut, wenn du schnell sehen willst, welche IPs überhaupt reagieren.

-PE – Nmap schickt einen normalen Ping (ICMP Echo) an die Rechner und wartet auf die Antwort. Klappt gut, wenn Pings im Netz erlaubt sind. Viele Geräte oder Firewalls blockieren Pings manchmal, dann findet -PE nicht alle Rechner. Verwende es, wenn du weißt, dass Pings erlaubt sind.

-PR – Nmap fragt auf der lokalen Netzebene nach, also direkt die Hardware‑Adressen, und findet so Rechner sehr zuverlässig, auch wenn Pings blockiert werden. Das funktioniert nur im gleichen lokalen Netzwerk und braucht meist erhöhte Rechte (sudo). Nutze -PR, wenn man auf einem LAN genau wissen will, wer da ist.
